...
const CreateOrder = () => {
    ...
    const [formData, setFormData] = useState({
      ...
      shipmentDate: "",
      totalAmount: 0, // Add the totalAmount field here
    });
    ...
    useEffect(() => {
      ...
      // Update the formData totalAmount when the total changes
      setFormData((prevData) => ({ ...prevData, totalAmount: newTotal }));
    }, [rows]);
    ...
    const handleSubmit = () => {
        ...
        // Create orderItems array from rows
        const orderItems = rows.map((row) => ({
          product: row.product,          // Product ID
          quantity: row.quantity,        // Quantity of the product
          fullPrice: row.unitPrice,      // Unit price
        }));
      
        const jsonData = {
          orderDate: formData.orderDate,
          orderNotes: formData.orderNotes,
          customer: selectedCustomer.customerId,  // Customer ID
          discountAmount: formData.discountAmount,
          billingAddress: formData.billingAddress,
          totalAmount: total,  // Total amount from the rows
        ...
        const fetchData = async (data) => {
            try {
              const response = await apiNonAuth.post("wholeSale/create-order",data);
      ...
      fetchData(jsonData);
        ...
        navigate('/order/wholesale/list');
        // You can now submit `jsonData` to your API or further process it
      };
