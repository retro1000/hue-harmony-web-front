...
import { TButton, SearchBarDefault, Breadcrumb, SimpleCard, MuiTable} from "app/components";
        ...
        <Container>
          ...
          <Stack sx={{display: 'flex', justifyContent: 'center', alignItems: 'flex-start', width: '100%'}} spacing={5}>
              <Box gap={'0.5em'} display={'flex'} flexWrap={'wrap'} sx={{width: '100%'}}>
                <TButton startIcon={<AddIcon />} variant="contained" color="primary" label='GRN' title="Add new GRN"></TButton>
              </Box>
