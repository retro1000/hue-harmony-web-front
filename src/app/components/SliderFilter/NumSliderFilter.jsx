...
const NumSliderFilter = ({ label, labelSx, curr, heading, sx, min, max, range, setRange, minWidth }) => {
//   const [range, setrange] = useState([800, 156940]);
  ...
  return (
    <Box sx={{ width: '100%', padding: 2, minWidth: minWidth || 250 }}>
      {
        heading && 
        <Typography fontSize={'1.1em'} gutterBottom sx={labelSx} variant={`${labelSx && 'body1'}`}>
          {heading}
        </Typography>
      }
      <Slider
